...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://github.com/hossain343)
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/hussain.termux.tech.bd')
        return None
...
\033[1;32m │\33[37;41m\t     BD RENDOM CLONE VERSION 00-4     \33[0;m  │
 ...
 \033[1;32m┌────────────────────────────────────────────────┐
 \033[1;32m│\033[1;31m➣\033[1;91m DEVELOPMENT     \033[1;31m:\033[1;32m MST ONDRILA
...
def i():
    ...
    print('IDS SAVED IN HOSSAIN -OK.txt, HOSSAIN -CP.txt')
